...
Mintware supports any EVM wallet via WalletConnect and browser extensions.
...
- A referral code is generated for your wallet
- If you arrived via a referral link, the referral is recorded
- A brief welcome sheet will appear with your referral link

---

## Disconnecting

Hover over the wallet pill in the navigation bar and click the disconnect button that appears. You'll be returned to the landing page.

...
// (deposit USDG → earn while staged → provide liquidity to a curated pool → spend the fees), not the
// full V2 vision. Honest testnet framing; no par / guaranteed / deposit-savings language.
...
const STEPS: [string, string, string][] = [
  ['01', 'Deposit USDG', 'It earns from the moment it lands — staged in a lending vault until it’s paired into a pool.'],
  ['02', 'Provide liquidity', 'Your capital joins a curated Uniswap v4 pool and earns a share of every swap’s fees.'],
  ['03', 'Spend the fees', 'Harvested fees fund a spendable balance. Your principal keeps working — never spent.'],
]
      ...
      <section className="bg-ground-cool border-b border-hair-soft">
        <div className="mx-auto max-w-[1000px] px-7 max-[640px]:px-[18px] pt-[84px] pb-[64px] max-[640px]:pt-[56px] flex flex-col items-center text-center">
          ...
          <h1 className="font-atx-display font-semibold text-ink tracking-[-0.04em] leading-[1.04] text-[clamp(2.4rem,6vw,4.2rem)] [text-wrap:balance] max-w-[16ch]">
            Earn on the pools. <span className="text-gradient-accent">Spend the fees.</span>
          </h1>
          <p className="text-ink-mid text-[clamp(1.02rem,1.6vw,1.24rem)] leading-[1.55] mt-6 max-w-[52ch]">
            Deposit USDG. It provides liquidity to a curated Robinhood Chain pool and earns trading fees —
            and you spend the fees, never your principal. No range to pick, no rebalancing to manage.
          </p>
        ...
        <div className="mx-auto max-w-[1000px] px-7 max-[640px]:px-[18px] py-[64px]">
          <GradientPanel tone="lavender" className="p-[36px] max-[640px]:p-7 text-center flex flex-col items-center">
            ...
            <h2 className="font-atx-display font-semibold text-ink tracking-[-0.03em] leading-[1.1] text-[clamp(1.5rem,2.6vw,2.1rem)] mt-3 max-w-[22ch] [text-wrap:balance]">
              Idle USDG keeps earning lending yield. Deployed USDG earns pool fees. You spend the fees.
            </h2>

...
// This is the "select your org" surface the terminal's action buttons route into. Chrome comes from
// the shared TeamTerminalShell layout (app/app/org/(guarded)/layout.tsx) — same shell as /app/team/*.

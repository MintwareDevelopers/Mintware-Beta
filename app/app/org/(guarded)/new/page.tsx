...
// new org home. Static /app/org/new wins over the dynamic /app/org/[slug], so no collision. Chrome comes
// from the shared TeamTerminalShell layout — same shell as /app/team/*.

...
// Design v2 (Privy-esque). Profile is now the REPUTATION / IDENTITY surface — the
// money home (balance / earn / spend) moved to /app/account (the LSA). This page
// leads with the Attribution score and keeps referrals/invite.
      ...
      <section className="bg-ground-cool border-b border-hair-soft">
        <div className="mx-auto max-w-[1040px] px-6 max-sm:px-4 py-[64px] max-sm:py-[44px]">
          ...
          <p className="text-ink-mid text-[clamp(1rem,1.5vw,1.15rem)] leading-[1.5] mt-5 max-w-[60ch]">
            Everything your wallet has done — holding, LPing, referring — scored into one number. Your money lives in your <Link href="/app/account" className="text-peri-deep font-medium no-underline">Account</Link>; this is your identity.
          </p>
        </div>
      </section>

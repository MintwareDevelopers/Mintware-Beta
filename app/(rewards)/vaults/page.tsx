  ...
  return (
    <div className="fixed inset-0 z-[999] flex flex-col items-center justify-center backdrop-blur-[14px] bg-white/70 font-atx-display">
      <div className="text-center max-w-[380px] px-6">
        <div className="font-atx-display text-[24px] font-medium tracking-[-0.02em] text-ink mb-2">Vaults — Coming Soon</div>
  ...
  return (
    <div className="font-atx-display bg-white min-h-screen text-ink overflow-x-clip">
      ...
      <div className="border-b border-hair-soft bg-ground-cool">
        <div className="max-w-[1100px] mx-auto px-6 py-2.5 max-[800px]:px-4 text-[11px] text-ink-mid flex items-center gap-2.5 flex-wrap">
          <span className="w-[7px] h-[7px] rounded-full bg-peri inline-block shrink-0" />
          <span className="uppercase tracking-[0.14em] font-semibold">In testing on Base Sepolia</span>
          <span className="text-ink-soft">Figures below are illustrative — the mechanism is what’s live.</span>
        </div>
      </div>
      ...
      <section className="bg-ground-cool border-b border-hair-soft">
        <div className="mx-auto max-w-[1100px] px-6 max-[800px]:px-4 py-[80px] max-[800px]:py-[52px]">
          <h1 className="font-atx-display font-medium text-ink tracking-[-0.04em] leading-[1.02] text-[clamp(2.2rem,5.4vw,3.9rem)] max-w-[16ch] [text-wrap:balance]">
            {HEAD[0]}<span className="text-peri">{HEAD[1]}</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 mt-9">
            <Link href="/app/vaults" className="glass-pill">Browse the vaults →</Link>
      ...
      <section className="bg-white border-b border-hair-soft">
        <div className="max-w-[1100px] mx-auto px-6 py-[72px] max-[800px]:px-4 max-[800px]:py-[52px] mw-reveal">
          ...
          <h2 className="font-atx-display font-medium text-ink tracking-[-0.035em] leading-[1.04] text-[clamp(1.7rem,3.4vw,2.6rem)] mt-3.5 max-w-[20ch] [text-wrap:balance]">
            The same engine, <span className="text-peri">two different jobs.</span>
          </h2>
        ...
        <div className="max-w-[1100px] mx-auto px-6 py-[72px] max-[800px]:px-4 max-[800px]:py-[52px] mw-reveal">
          <GradientPanel tone="lavender" className="p-10 max-[800px]:p-6 flex items-center justify-between gap-6 flex-wrap">
            <div className="max-w-[46ch]">
              <div className="font-atx-display text-[clamp(1.4rem,2.4vw,2rem)] font-medium tracking-[-0.02em] leading-[1.1] text-ink [text-wrap:balance]">
            ...
            <div className="flex gap-3 flex-wrap">
              <Link href="/app/vaults" className="glass-pill whitespace-nowrap">Browse the vaults →</Link>

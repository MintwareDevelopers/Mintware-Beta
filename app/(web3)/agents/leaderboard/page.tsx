    ...
    <div className="page-earn bg-mw-bg min-h-screen">
      <div className="px-7 pb-12 pt-6 max-w-[1100px] mx-auto max-[800px]:px-4 max-[800px]:pt-5">
        ...
        <div className="bg-white rounded-[12px] shadow-card overflow-hidden mb-5">
          {loading && <div className="text-center py-14 text-mw-ink-3 text-[14px] font-sans">Loading agents…</div>}
          {error && <div className="text-center py-14 text-[#ef4444] text-[14px] font-sans">{error}</div>}
                    ...
                    >
                      ...
                      <td className="lb-td">
                        <div className="flex items-center gap-3">
                          <div className="w-[34px] h-[34px] rounded-[9px] flex items-center justify-center text-[11px] font-bold font-mono shrink-0" style={{ background: av.bg, color: av.letter }}>
                          ...
                          <div>
                            <div className="flex items-center gap-[5px] flex-wrap">
                              ...
                              {row.is_transparent && <span className="inline-flex items-center bg-[rgba(34,197,94,0.09)] text-[#22c55e] rounded-[5px] px-[5px] py-[2px] text-[9px] font-bold tracking-[0.4px] uppercase">✦ Transparent</span>}
                              {row.erc8004_token_id && <span className="inline-flex items-center bg-[rgba(79,126,247,0.08)] text-mw-brand rounded-[5px] px-[5px] py-[2px] text-[9px] font-bold tracking-[0.4px] uppercase">ERC-8004</span>}
                              {isMe && <span className="inline-flex items-center bg-[rgba(79,126,247,0.12)] text-mw-brand rounded-[5px] px-[5px] py-[2px] text-[9px] font-bold tracking-[0.4px] uppercase">You</span>}
                            </div>
                          </div>
                        </div>
                      </td>
        ...
        <div className="mw-accent-card rounded-[12px] shadow-card p-6 flex items-start justify-between gap-6 flex-wrap">
          <div>
            ...
            <a href="/docs/ai-attribution/sdk" target="_blank" rel="noopener" className="inline-flex items-center gap-1 mt-3 text-mw-brand text-[13px] font-semibold font-sans no-underline hover:underline">
              View SDK docs →
            </a>
          </div>
